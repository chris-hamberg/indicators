...
class Tarot(CoreIndicators):
    ...
    - scale (int): The timescale of the data in minutes (default is 1 (for 1-min)).
    ...
    def pattern_detection(self, timeseries, n, scale):
        ...
        pattern = self.crayon.detection(timeseries, n, scale, mode="cumulative")
